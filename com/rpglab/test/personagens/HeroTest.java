...
public class HeroTest {
    ...
    @Test
    //Teste interface combatente
    public void testCombatente() {
        Hero heroi = new Demigod("Herói Teste", 100, 10, 1, 0, new Sword(), 50, 0.5f, 10);
    ...
    public void testAtacar() throws RecursoException {
        ...
        Monster monstro = new Ciclop("Alvo Teste", 100, 10, new Club(), 50);
